...
function clearForm() {
  ...
  document.getElementById('dispNameError').textContent = '';
  document.getElementById('dispIPError').textContent = '';
  document.getElementById('dispName').classList.remove('input-error');
  document.getElementById('dispIP').classList.remove('input-error');
}
